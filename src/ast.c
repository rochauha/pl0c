...
{
	switch (token.symbol) {
		case VAR: return AST_VAR_DECL;
		case CONST: return AST_CONST_DECL;
		case PROCEDURE: return AST_PROC_DECL;
		case CALL: return AST_CALL;
		case PLUS: return AST_ADD;
		case MINUS: return AST_SUB;
		case TIMES: return AST_MUL;
		case SLASH: return AST_DIV;
		case ODD: return AST_ODD;
		case ASSIGN: return AST_ASSIGN;
		case GTE: return AST_GTE;
		case LTE: return AST_LTE;
		case GREATER: return AST_GT;
		case LESSER: return AST_LT;
		case EQUAL: return AST_EQ;
		case NOTEQUAL: return AST_NEQ;
		case NUM: return AST_NUM;
		case IDENT: return AST_IDENT;
		case PRINT: return AST_PRINT;
		case SCAN: return AST_SCAN;
		case BEGIN: return AST_STMT_BLOCK;
		case IF: return AST_IF;
		case WHILE: return AST_WHILE;
	}
}
